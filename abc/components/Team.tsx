...
export default function Carousel() {
  return (
    ...
    <div className="relative w-full overflow-hidden">
      ...
      {/* Giant Text Overlay */}
      <div className="absolute inset-0 z-10 flex items-center justify-start ml-[50px] pointer-events-none py-[10vh] pt-[43vh]">
  <h2 className="text-white text-6xl md:text-8xl font-text opacity-90 drop-shadow-lg leading-tight">
      ...
      <div className="relative perspective-[800px] z-0">
        <div className="skewed-carousel animate-carousel">
